                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    <div className="form-control flex-row gap-x-10">
                        <label className="label gap-x-5 cursor-pointer">
                            ...
                            <input type="radio" name="radio-6" className="radio checked:bg-red-500" value="company" {...register("userType")}/>
                        </label>
                        <label className="label gap-x-5  cursor-pointer">
                            <span className="label-text font-medium">Indiviual</span> 
                            <input type="radio" name="radio-6" className="radio checked:bg-blue-500" value="indiviual" checked {...register("userType")} />
                        </label>
                    </div>
                </div>
                {/* <div className="form-control w-full max-w-xs">
