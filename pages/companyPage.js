    ...
    <div className="w-full h-screen flex overflow-hidden">
            ...
            <div className="my-5 bg-base-300 h-full p-2 w-4/5 mx-auto rounded-md drop-shadow-xl">
              ...
              <div className="my-3">
                ...
                <div className="mb-2">
                  ...
                  <h2 className="badge badge-secondary text-base py-4 mt-2">Technology</h2>
                </div>
                <div className="mb-2">
        ...
        <div className="w-5/6 h-full my-4">
          <div className="px-10 w-full my-2">
            ...
            <p className="m-4 font-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia, enim iste. A maxime tenetur ipsam nihil, obcaecati nobis! Hic, corporis!</p>
            <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center gap-x-3">
                ...
                <Icon icon="fe:facebook" color="#4267b2" className="text-2xl cursor-pointer" />
                <Icon icon="entypo:link" color="black" className="text-2xl cursor-pointer" />
              </div>
            </div>
          ...
          <div className="w-full h-full px-20">
            <ul className="flex gap-x-5">
              <li className="font-bold text-xl px-4 py-2 border-b-2 border-slate-300 rounded-sm">Overview</li>
              <li className="font-bold text-xl px-4 py-2 border-b-2 border-slate-300 rounded-sm">Funding</li>
              <li className="font-bold text-xl px-4 py-2 border-b-2 border-slate-300 rounded-sm">Jobs <div className="badge badge-base text-white text-sm">12</div></li>
            </ul>
